...
cy = 0;
cx = 0;
pos_LEFT = width_Core_Leg/2+width_Window+width_internal_Core_Leg;
pos_RIGHT = width_Core_Leg/2+width_Window+width_internal_Core_Leg;
shift = 2.5*gap_Core_Coil + width_Coil_PRIM + width_Coil_SECOND;
P_CoreR_0s=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg-2*r, -height_Core/2+cy, 0, c_Core};
P_CoreR_0c=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg-2*r, -height_Core/2+2*r+cy, 0, c_Core};
P_CoreR_0e=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg, -height_Core/2+2*r+cy, 0, c_Core};
P_CoreR_1s=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg, height_Core/2-2*r+cy, 0, c_Core};
P_CoreR_1c=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg-2*r, height_Core/2-2*r+cy, 0, c_Core};
P_CoreR_1e=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg-2*r, height_Core/2+cy, 0, c_Core};
P_CoreL_1s=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg+2*r, height_Core/2+cy, 0, c_Core};
P_CoreL_1c=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg+2*r, height_Core/2-2*r+cy, 0, c_Core};
P_CoreL_1e=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg, height_Core/2-2*r+cy, 0, c_Core};
P_CoreL_0s=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg, -height_Core/2+2*r+cy, 0, c_Core};
P_CoreL_0c=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg+2*r, -height_Core/2+2*r+cy, 0, c_Core};
P_CoreL_0e=newp; Point(newp) = {cx-pos_LEFT-shift-width_external_Core_Leg+2*r, -height_Core/2+cy, 0, c_Core};
l_Core_Env[]={};
...
P_Leg_0_L_0=newp; Point(newp) = {cx+-pos_LEFT-shift-width_external_Core_Leg, -height_Window/2.+cy, 0, c_Core};
P_Leg_0_R_0=newp; Point(newp) = {cx+-pos_LEFT-shift,  -height_Window/2+cy, 0, c_Core};
P_Leg_1_L_0=newp; Point(newp) = {cx+-pos_LEFT, -height_Window/2.+cy, 0, c_Core};
P_Leg_1_R_0=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg,  -height_Window/2+cy, 0, c_Core};
...
P_Leg_3_L_0=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg, -height_Window/2.+cy, 0, c_Core};
P_Leg_3_R_0=newp; Point(newp) = {cx+pos_RIGHT, -height_Window/2.+cy, 0, c_Core};
P_Leg_4_L_0=newp; Point(newp) = {cx+pos_RIGHT+shift, -height_Window/2.+cy, 0, c_Core};
P_Leg_4_R_0=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg, -height_Window/2.+cy, 0, c_Core};

If (gap_Core==0)
    // AIR_01_WINDOW
    P_01_Window_L_1s=newp; Point(newp) = {cx+-pos_LEFT-shift, height_Window/2 - r+cy, 0, c_Core};
    P_01_Window_L_1c=newp; Point(newp) = {cx+-pos_LEFT-shift + r, height_Window/2 - r+cy, 0, c_Core};
    P_01_Window_L_1e=newp; Point(newp) = {cx+-pos_LEFT-shift + r, height_Window/2+cy, 0, c_Core};
    P_01_Window_R_1s=newp; Point(newp) = {cx+-pos_LEFT - r, height_Window/2+cy, 0, c_Core};
    P_01_Window_R_1c=newp; Point(newp) = {cx+-pos_LEFT - r, height_Window/2 - r+cy, 0, c_Core};
    P_01_Window_R_1e=newp; Point(newp) = {cx+-pos_LEFT, height_Window/2 - r+cy, 0, c_Core};
    P_01_Window_R_0s=newp; Point(newp) = {cx+-pos_LEFT, -height_Window/2 + r+cy, 0, c_Core};
    P_01_Window_R_0c=newp; Point(newp) = {cx+-pos_LEFT - r, -height_Window/2 + r+cy, 0, c_Core};
    P_01_Window_R_0e=newp; Point(newp) = {cx+-pos_LEFT - r, -height_Window/2+cy, 0, c_Core};
    P_01_Window_L_0s=newp; Point(newp) = {cx+-pos_LEFT-shift + r, -height_Window/2+cy, 0, c_Core};
    P_01_Window_L_0c=newp; Point(newp) = {cx+-pos_LEFT-shift + r, -height_Window/2 + r+cy, 0, c_Core};
    P_01_Window_L_0e=newp; Point(newp) = {cx+-pos_LEFT-shift, -height_Window/2 + r+cy, 0, c_Core};
    
    l_01_Window[]={};
    l_01_Window[]+=newl; Circle(newl) = {P_01_Window_L_1s, P_01_Window_L_1c, P_01_Window_L_1e};
    l_01_Window[]+=newl; Line(newl) = {P_01_Window_L_1e, P_01_Window_R_1s};
    l_01_Window[]+=newl; Circle(newl) = {P_01_Window_R_1s, P_01_Window_R_1c, P_01_Window_R_1e};
    l_01_Window[]+=newl; Line(newl) = {P_01_Window_R_1e, P_01_Window_R_0s};
    l_01_Window[]+=newl; Circle(newl) = {P_01_Window_R_0s, P_01_Window_R_0c, P_01_Window_R_0e};
    l_01_Window[]+=newl; Line(newl) = {P_01_Window_R_0e, P_01_Window_L_0s};
    l_01_Window[]+=newl; Circle(newl) = {P_01_Window_L_0s, P_01_Window_L_0c, P_01_Window_L_0e};
    l_01_Window[]+=newl; Line(newl) = {P_01_Window_L_0e, P_01_Window_L_1s};
    // AIR_12_WINDOW
    P_12_Window_L_1s=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg, height_Window/2 - r+cy, 0, c_Core};
    P_12_Window_L_1c=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, height_Window/2 - r+cy, 0, c_Core};
    P_12_Window_L_1e=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, height_Window/2+cy, 0, c_Core};
    ...
    P_12_Window_L_0s=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, -height_Window/2+cy, 0, c_Core};
    P_12_Window_L_0c=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, -height_Window/2 + r+cy, 0, c_Core};
    P_12_Window_L_0e=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg, -height_Window/2 + r+cy, 0, c_Core};
    ...
    P_23_Window_R_1s=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r, cy+height_Window/2, 0, c_Core};
    P_23_Window_R_1c=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r, cy+height_Window/2 - r, 0, c_Core};
    P_23_Window_R_1e=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg, cy+height_Window/2 - r, 0, c_Core};
    P_23_Window_R_0s=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg, cy+-height_Window/2 + r, 0, c_Core};
    P_23_Window_R_0c=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r, cy+-height_Window/2 + r, 0, c_Core};
    P_23_Window_R_0e=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r, cy+-height_Window/2, 0, c_Core};
    ...
    // AIR_34_WINDOW
    P_34_Window_L_1s=newp; Point(newp) = {cx+pos_RIGHT, cy+height_Window/2 - r, 0, c_Core};
    P_34_Window_L_1c=newp; Point(newp) = {cx+pos_RIGHT + r, cy+height_Window/2 - r, 0, c_Core};
    P_34_Window_L_1e=newp; Point(newp) = {cx+pos_RIGHT + r, cy+height_Window/2, 0, c_Core};
    P_34_Window_R_1s=newp; Point(newp) = {cx+pos_RIGHT+shift - r, cy+height_Window/2, 0, c_Core};
    P_34_Window_R_1c=newp; Point(newp) = {cx+pos_RIGHT+shift - r, cy+height_Window/2 - r, 0, c_Core};
    P_34_Window_R_1e=newp; Point(newp) = {cx+pos_RIGHT+shift, cy+height_Window/2 - r, 0, c_Core};
    P_34_Window_R_0s=newp; Point(newp) = {cx+pos_RIGHT+shift, cy+-height_Window/2 + r, 0, c_Core};
    P_34_Window_R_0c=newp; Point(newp) = {cx+pos_RIGHT+shift - r, cy+-height_Window/2 + r, 0, c_Core};
    P_34_Window_R_0e=newp; Point(newp) = {cx+pos_RIGHT+shift - r, cy+-height_Window/2, 0, c_Core};
    P_34_Window_L_0s=newp; Point(newp) = {cx+pos_RIGHT + r, cy+-height_Window/2, 0, c_Core};
    P_34_Window_L_0c=newp; Point(newp) = {cx+pos_RIGHT + r, cy+-height_Window/2 + r, 0, c_Core};
    P_34_Window_L_0e=newp; Point(newp) = {cx+pos_RIGHT, cy+-height_Window/2 + r, 0, c_Core};
    
    l_34_Window[]={};
    l_34_Window[]+=newl; Circle(newl) = {P_34_Window_L_1s, P_34_Window_L_1c, P_34_Window_L_1e};
    l_34_Window[]+=newl; Line(newl) = {P_34_Window_L_1e, P_34_Window_R_1s};
    l_34_Window[]+=newl; Circle(newl) = {P_34_Window_R_1s, P_34_Window_R_1c, P_34_Window_R_1e};
    l_34_Window[]+=newl; Line(newl) = {P_34_Window_R_1e, P_34_Window_R_0s};
    l_34_Window[]+=newl; Circle(newl) = {P_34_Window_R_0s, P_34_Window_R_0c, P_34_Window_R_0e};
    l_34_Window[]+=newl; Line(newl) = {P_34_Window_R_0e, P_34_Window_L_0s};
    l_34_Window[]+=newl; Circle(newl) = {P_34_Window_L_0s, P_34_Window_L_0c, P_34_Window_L_0e};
    l_34_Window[]+=newl; Line(newl) = {P_34_Window_L_0e, P_34_Window_L_1s};

Else
    P_Leg_0_L_0=newp; Point(newp) = {cx+-pos_LEFT-shift-width_external_Core_Leg,cy+ -height_Window/2., 0, c_Base};
    P_Leg_0_R_0s=newp; Point(newp) = {cx+-pos_LEFT-shift-r, -height_Window/2.+cy, 0, c_Base};
    P_Leg_0_R_0c=newp; Point(newp) = {cx+-pos_LEFT-shift-r, -height_Window/2.+r+cy, 0, c_Base};
    P_Leg_0_R_0e=newp; Point(newp) = {cx+-pos_LEFT-shift, -height_Window/2.+r+cy, 0, c_Base};
    P_Leg_0_L_1=newp; Point(newp) = {cx+-pos_LEFT-shift-width_external_Core_Leg,cy+ height_Window/2., 0, c_Base};
    P_Leg_0_R_1s=newp; Point(newp) = {cx+-pos_LEFT-shift, height_Window/2 - r+cy, 0, c_Core};
    P_Leg_0_R_1c=newp; Point(newp) = {cx+-pos_LEFT-shift + r, height_Window/2 - r+cy, 0, c_Core};
    P_Leg_0_R_1e=newp; Point(newp) = {cx+-pos_LEFT-shift + r, height_Window/2+cy, 0, c_Core};

    P_Leg_1_L_0s=newp; Point(newp) = {cx+-pos_LEFT,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_1_L_0c=newp; Point(newp) = {cx+-pos_LEFT+r,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_1_L_0e=newp; Point(newp) = {cx+-pos_LEFT+r,cy+ -height_Window/2., 0, c_Base};
    P_Leg_1_R_0s=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg-r, -height_Window/2.+cy, 0, c_Base};
    P_Leg_1_R_0c=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg-r, -height_Window/2.+r+cy, 0, c_Base};
    P_Leg_1_R_0e=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg, -height_Window/2.+r+cy, 0, c_Base};
    P_Leg_1_L_1s=newp; Point(newp) = {cx+-pos_LEFT-r ,cy+ height_Core/2, 0, c_Core};
    P_Leg_1_L_1c=newp; Point(newp) = {cx+-pos_LEFT-r ,cy+ height_Core/2-r, 0, c_Core};
    P_Leg_1_L_1e=newp; Point(newp) = {cx+-pos_LEFT ,cy+ height_Core/2-r, 0, c_Core};
    P_Leg_1_R_1s=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg, height_Window/2 - r+cy, 0, c_Core};
    P_Leg_1_R_1c=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, height_Window/2 - r+cy, 0, c_Core};
    P_Leg_1_R_1e=newp; Point(newp) = {cx+-pos_LEFT+width_internal_Core_Leg + r, height_Window/2+cy, 0, c_Core};
    ...
    P_Leg_3_L_0s=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_3_L_0c=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg+r,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_3_L_0e=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg+r,cy+ -height_Window/2., 0, c_Base};
    P_Leg_3_R_0s=newp; Point(newp) = {cx+pos_RIGHT-r,cy+ -height_Window/2., 0, c_Base};
    P_Leg_3_R_0c=newp; Point(newp) = {cx+pos_RIGHT-r,cy+ -height_Window/2.-r, 0, c_Base};
    P_Leg_3_R_0e=newp; Point(newp) = {cx+pos_RIGHT,cy+ -height_Window/2.-r, 0, c_Base};
    P_Leg_3_L_1s=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r,cy+ height_Window/2, 0, c_Core};
    P_Leg_3_L_1c=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg - r,cy+ height_Window/2 - r, 0, c_Core};
    P_Leg_3_L_1e=newp; Point(newp) = {cx+pos_RIGHT-width_internal_Core_Leg,cy+ height_Window/2 - r, 0, c_Core};
    P_Leg_3_R_1s=newp; Point(newp) = {cx+pos_RIGHT+r, cy+height_Core/2., 0, c_Core};
    P_Leg_3_R_1c=newp; Point(newp) = {cx+pos_RIGHT+r, cy+height_Core/2.-r, 0, c_Core};
    P_Leg_3_R_1e=newp; Point(newp) = {cx+pos_RIGHT, cy+height_Core/2.-r, 0, c_Core};
    
    P_Leg_4_L_0s=newp; Point(newp) = {cx+pos_RIGHT+shift,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_4_L_0c=newp; Point(newp) = {cx+pos_RIGHT+shift+r,cy+ -height_Window/2.+r, 0, c_Base};
    P_Leg_4_L_0e=newp; Point(newp) = {cx+pos_RIGHT+shift+r,cy+ -height_Window/2., 0, c_Base};
    P_Leg_4_R_0=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg,cy+ -height_Window/2., 0, c_Base};
    P_Leg_4_L_1s=newp; Point(newp) = {cx+pos_RIGHT+shift - r,cy+ height_Window/2, 0, c_Core};
    P_Leg_4_L_1c=newp; Point(newp) = {cx+pos_RIGHT+shift - r,cy+ height_Window/2 - r, 0, c_Core};
    P_Leg_4_L_1e=newp; Point(newp) = {cx+pos_RIGHT+shift,cy+ height_Window/2 - r, 0, c_Core};
    P_Leg_4_R_1=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg, cy+height_Core/2., 0, c_Core};
    
    l_Core_01_In[]={};
    l_Core_01_In[]+=newl; Circle(newl) = {P_Leg_0_R_0s, P_Leg_0_R_0c, P_Leg_0_R_0e};
    l_Core_01_In[]+=newl; Line(newl) = {P_Leg_0_R_0e, P_Leg_0_R_1s};
    ...
    l_Core_01_In[]+=newl; Line(newl) = {P_Leg_1_L_1e, P_Leg_1_L_0s};
    l_Core_01_In[]+=newl; Circle(newl) = {P_Leg_1_L_0s, P_Leg_1_L_0c, P_Leg_1_L_0e};
    ...
    l_Core_34_In[]={};
    l_Core_34_In[]+=newl; Circle(newl) = {P_Leg_3_R_0s, P_Leg_3_R_0c, P_Leg_3_R_0e};
    l_Core_34_In[]+=newl; Line(newl) = {P_Leg_3_R_0e, P_Leg_3_R_1s};
    ...
    l_Core_34_In[]+=newl; Line(newl) = {P_Leg_4_L_1e, P_Leg_4_L_0s};
    l_Core_34_In[]+=newl; Circle(newl) = {P_Leg_4_L_0s, P_Leg_4_L_0c, P_Leg_4_L_0e};
    
    l_Core_40_Out[]={};
    l_Core_40_Out[]+=newl; Line(newl) = {P_Leg_4_R_0, P_Leg_4_R_1};
    l_Core_40_Out[]+=newl; Line(newl) = {P_Leg_4_R_1, P_Leg_0_L_1};
    l_Core_40_Out[]+=newl; Line(newl) = {P_Leg_0_L_1, P_Leg_0_L_0};
    
    l_Core_Leg_0_Y0[]={};
    l_Core_Leg_0_Y0[]+=newl; Line(newl) = {P_Leg_0_L_0, P_Leg_0_R_0s};

    l_Core_Leg_1_Y0[]={};
    l_Core_Leg_1_Y0[]+=newl; Line(newl) = {P_Leg_1_L_0s, P_Leg_1_R_0s};

    l_Core_Leg_2_Y0[]={};
    l_Core_Leg_2_Y0[]+=newl; Line(newl) = {P_Leg_2_L_0e, P_Leg_2_R_0s};

    l_Core_Leg_3_Y0[]={};
    l_Core_Leg_3_Y0[]+=newl; Line(newl) = {P_Leg_3_L_0e, P_Leg_3_R_0e};

    l_Core_Leg_4_Y0[]={};
    l_Core_Leg_4_Y0[]+=newl; Line(newl) = {P_Leg_4_L_0e, P_Leg_4_R_0};

    ll_Core=newll; Curve Loop(newll) = {l_Core_01_In[], l_Core_Leg_1_Y0[],
                                        l_Core_12_In[], l_Core_Leg_2_Y0[],
                                         l_Core_23_In[], l_Core_Leg_3_Y0[], 
                                         l_Core_34_In[], l_Core_Leg_4_Y0[], 
                                         l_Core_40_In[], l_Core_Leg_0_Y0[]};
    //Base
    P_L_0=newp; Point(newp) = {cx+-pos_LEFT-shift-width_external_Core_Leg, -height_Core/2+cy, 0, c_Core};
    x_[] = Point{P_Leg_0_L_0};
    P_Leg_0_L_0_B=newp; Point(newp) = {x_[0], x_[1]-gap_Core, 0, c_Base};
    x_[] = Point{P_Leg_0_R_0s};
    P_Leg_0_R_0_B=newp; Point(newp) = {x_[0], x_[1]-gap_Core, 0, c_Base};
    x_[] = Point{P_Leg_1_L_0e};
    ...
    P_R_0=newp; Point(newp) = {cx+pos_RIGHT+shift+width_external_Core_Leg,cy+ -height_Core/2, 0, c_Core};
    l_Base[]={};
