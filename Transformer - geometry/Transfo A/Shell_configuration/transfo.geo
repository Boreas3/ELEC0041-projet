...
If (gap_Core==0)
    // Air 01 Window
    ll_01_Window=newll; Curve Loop(newll) = {l_01_Window[]};
    s_01_Window=news; Plane Surface(news) = {ll_01_Window, ll_Coil_A_prim_m, ll_Coil_A_second_m};
    ...
    // Air 34 Window
    ll_34_Window=newll; Curve Loop(newll) = {l_34_Window[]};
    s_34_Window=news; Plane Surface(news) = {ll_34_Window, ll_Coil_C_prim_p, ll_Coil_C_second_p};
    ...
    Physical Surface("AIR_EXT", AIR_EXT) = {s_Air_Ext, s_01_Window, s_12_Window, s_23_Window, s_34_Window};
