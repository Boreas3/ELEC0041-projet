...
// CORE
// Envelop
shift = 2.5*gap_Core_Coil_1 + width_Coil_PRIM + width_Coil_SECOND;
P_Core_R_0s=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg-2*r, -height_Core/2, 0, c_Core};
P_Core_R_0c=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg-2*r, -height_Core/2+2*r, 0, c_Core};
P_Core_R_0e=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, -height_Core/2+2*r, 0, c_Core};
P_Core_R_1s=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, height_Core/2-2*r, 0, c_Core};
P_Core_R_1c=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg-2*r, height_Core/2-2*r, 0, c_Core};
P_Core_R_1e=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg-2*r, height_Core/2, 0, c_Core};
P_Core_L_1s=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg+2*r, height_Core/2, 0, c_Core};
P_Core_L_1c=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg+2*r, height_Core/2-2*r, 0, c_Core};
P_Core_L_1e=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, height_Core/2-2*r, 0, c_Core};
P_Core_L_0s=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, -height_Core/2+2*r, 0, c_Core};
P_Core_L_0c=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg+2*r, -height_Core/2+2*r, 0, c_Core};
P_Core_L_0e=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg+2*r, -height_Core/2, 0, c_Core};
l_Core_Env[]={};
...
p_Leg_0_L_0=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, -height_Window/2., 0, c_Base};
...
p_Leg_4_R_0=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, -height_Window/2., 0, c_Base};
...
Else
    p_Leg_0_L_0=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, -height_Window/2., 0, c_Base};
    p_Leg_0_R_0s=newp; Point(newp) = {-width_Core/2.-shift-r, -height_Window/2., 0, c_Base};
    p_Leg_0_R_0c=newp; Point(newp) = {-width_Core/2.-shift-r, -height_Window/2.+r, 0, c_Base};
    p_Leg_0_R_0e=newp; Point(newp) = {-width_Core/2.-shift, -height_Window/2.+r, 0, c_Base};
    p_Leg_0_L_1=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, height_Core/2., 0, c_Core};
    ...
    p_Leg_1_L_0s=newp; Point(newp) = {-width_Core/2., -height_Window/2.+r, 0, c_Base};
    p_Leg_1_L_0c=newp; Point(newp) = {-width_Core/2.+r, -height_Window/2.+r, 0, c_Base};
    p_Leg_1_L_0e=newp; Point(newp) = {-width_Core/2.+r, -height_Window/2., 0, c_Base};
    ...
    p_Leg_3_R_0s=newp; Point(newp) = {width_Core/2.-r, -height_Window/2., 0, c_Base};
    p_Leg_3_R_0c=newp; Point(newp) = {width_Core/2.-r, -height_Window/2.+r, 0, c_Base};
    p_Leg_3_R_0e=newp; Point(newp) = {width_Core/2., -height_Window/2.+r, 0, c_Base};
    ...
    p_Leg_4_L_0s=newp; Point(newp) = {width_Core/2.+shift, -height_Window/2.+r, 0, c_Base};
    p_Leg_4_L_0c=newp; Point(newp) = {width_Core/2.+shift+r, -height_Window/2.+r, 0, c_Base};
    p_Leg_4_L_0e=newp; Point(newp) = {width_Core/2.+shift+r, -height_Window/2., 0, c_Base};
    p_Leg_4_R_0=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, -height_Window/2., 0, c_Base};
    ...
    p_Leg_4_R_1=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, height_Core/2., 0, c_Core};
    ...
    l_Core_Leg_1_Y0[]={};
    l_Core_Leg_1_Y0[]+=newl; Line(newl) = {p_Leg_1_L_0e, p_Leg_1_R_0s};

    l_Core_Leg_2_Y0[]={};
    l_Core_Leg_2_Y0[]+=newl; Line(newl) = {p_Leg_2_L_0e, p_Leg_2_R_0s};

    l_Core_Leg_3_Y0[]={};
    l_Core_Leg_3_Y0[]+=newl; Line(newl) = {p_Leg_3_L_0e, p_Leg_3_R_0s};
    ...
    // Base
    p_L_0=newp; Point(newp) = {-width_Core/2.-shift-external_width_Core_Leg, -height_Core/2, 0, c_Core};
    ...
    p_R_0=newp; Point(newp) = {width_Core/2.+shift+external_width_Core_Leg, -height_Core/2, 0, c_Core};
    l_Base[]={};
