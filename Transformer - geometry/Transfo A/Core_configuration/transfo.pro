...
DefineConstant[
  ...
  val_U_in = {2400, Name "Voltage at the primary side (phase to phase)"}
...
PostOperation {
  { Name Power_test; NameOfPostProcessing Magnetodynamics2D_av;
    Operation{
      Print[ S_app, OnRegion E_in_A, Format Table, File "UI3_A_core.txt"];
      Print[ S_app, OnRegion E_in_B, Format Table, File > "UI3_A_core.txt"];
      Print[ S_app, OnRegion E_in_C, Format Table, File > "UI3_A_core.txt"];
      Print[ U, OnRegion E_in_A, Format Table, File > "UI3_A_core.txt"];
      Print[ U, OnRegion E_in_B, Format Table, File > "UI3_A_core.txt"];
      Print[ U, OnRegion E_in_C, Format Table, File > "UI3_A_core.txt"];
      Print[ I, OnRegion E_in_A, Format Table, File > "UI3_A_core.txt"];
      Print[ I, OnRegion E_in_B, Format Table, File > "UI3_A_core.txt"];
      Print[ I, OnRegion E_in_C, Format Table, File > "UI3_A_core.txt"];
    }
  }
    ...
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        Print[ norm_of_I, OnRegion E_in_A, Format FrequencyTable,
          ...
          Echo[ "E_in_A", Format Table, File "UI3_A_core.txt" ];
          Print[ U, OnRegion E_in_A, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion E_in_A, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion E_in_A, Format FrequencyTable, File > "UI3_A_core.txt"];
          
          Echo[ "E_in_B", Format Table, File > "UI3_A_core.txt" ];
          Print[ U, OnRegion E_in_B, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion E_in_B, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion E_in_B, Format FrequencyTable, File > "UI3_A_core.txt"];
          
          Echo[ "E_in_C", Format Table, File > "UI3_A_core.txt" ];
          Print[ U, OnRegion E_in_C, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion E_in_C, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion E_in_C, Format FrequencyTable, File > "UI3_A_core.txt"];
          
          // In text file UI.txt: voltage and current of the secondary coil (from
          // R_out)
          Echo[ "R_load_A", Format Table, File > "UI3_A_core.txt" ];
          Print[ U, OnRegion R_load_A, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion R_load_A, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion R_load_A, Format FrequencyTable, File > "UI3_A_core.txt"];
      
          Echo[ "R_load_B", Format Table, File > "UI3_A_core.txt" ];
          Print[ U, OnRegion R_load_B, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion R_load_B, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion R_load_B, Format FrequencyTable, File > "UI3_A_core.txt"];
      
          Echo[ "R_load_C", Format Table, File > "UI3_A_core.txt" ];
          Print[ U, OnRegion R_load_C, Format FrequencyTable, File > "UI3_A_core.txt" ];
          Print[ I, OnRegion R_load_C, Format FrequencyTable, File > "UI3_A_core.txt"];
          Print[ S_app, OnRegion R_load_C, Format FrequencyTable, File > "UI3_A_core.txt"];
      EndIf
    }
  }
}
