...
PostOperation {
  { Name Power_test; NameOfPostProcessing Magnetodynamics2D_av;
    Operation{
      Print[ S_app, OnRegion E_in_A, Format Table, File "UI3_B_shell.txt"];
      Print[ S_app, OnRegion E_in_B, Format Table, File > "UI3_B_shell.txt"];
      Print[ S_app, OnRegion E_in_C, Format Table, File > "UI3_B_shell.txt"];
      Print[ U, OnRegion E_in_A, Format Table, File > "UI3_B_shell.txt"];
      Print[ U, OnRegion E_in_B, Format Table, File > "UI3_B_shell.txt"];
      Print[ U, OnRegion E_in_C, Format Table, File > "UI3_B_shell.txt"];
      Print[ I, OnRegion E_in_A, Format Table, File > "UI3_B_shell.txt"];
      Print[ I, OnRegion E_in_B, Format Table, File > "UI3_B_shell.txt"];
      Print[ I, OnRegion E_in_C, Format Table, File > "UI3_B_shell.txt"];
    }
  }
    ...
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        // E_in) (real and imaginary parts!)
          ...
          Echo[ "E_in_A", Format Table, File "UI3_B_shell.txt" ];
          Print[ U, OnRegion E_in_A, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion E_in_A, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion E_in_A, Format FrequencyTable, File > "UI3_B_shell.txt"];
          
          Echo[ "E_in_B", Format Table, File > "UI3_B_shell.txt" ];
          Print[ U, OnRegion E_in_B, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion E_in_B, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion E_in_B, Format FrequencyTable, File > "UI3_B_shell.txt"];
          
          Echo[ "E_in_C", Format Table, File > "UI3_B_shell.txt" ];
          Print[ U, OnRegion E_in_C, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion E_in_C, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion E_in_C, Format FrequencyTable, File > "UI3_B_shell.txt"];
          
          // In text file UI.txt: voltage and current of the secondary coil (from
          // R_out)
          Echo[ "R_load_A", Format Table, File > "UI3_B_shell.txt" ];
          Print[ U, OnRegion R_load_A, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion R_load_A, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion R_load_A, Format FrequencyTable, File > "UI3_B_shell.txt"];
      
          Echo[ "R_load_B", Format Table, File > "UI3_B_shell.txt" ];
          Print[ U, OnRegion R_load_B, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion R_load_B, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion R_load_B, Format FrequencyTable, File > "UI3_B_shell.txt"];
      
          Echo[ "R_load_C", Format Table, File > "UI3_B_shell.txt" ];
          Print[ U, OnRegion R_load_C, Format FrequencyTable, File > "UI3_B_shell.txt" ];
          Print[ I, OnRegion R_load_C, Format FrequencyTable, File > "UI3_B_shell.txt"];
          Print[ S_app, OnRegion R_load_C, Format FrequencyTable, File > "UI3_B_shell.txt"];
      EndIf
    }
  }
}
