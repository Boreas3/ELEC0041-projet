...
Include "transfo_shellA.geo";
Include "transfo_shellB.geo";
Include "transfo_shellC.geo";
...
If (gap_Core==0)
    ...
    s_12_A_Window=news; Plane Surface(news) = {ll_12_A_Window, ll_Coil_A_prim_m, ll_Coil_A_second_m};

    ll_12_B_Window=newll; Curve Loop(newll) = {l_12_B_Window[]};
    s_12_B_Window=news; Plane Surface(news) = {ll_12_B_Window, ll_Coil_B_prim_m, ll_Coil_B_second_m};

    ll_12_C_Window=newll; Curve Loop(newll) = {l_12_C_Window[]};
    s_12_C_Window=news; Plane Surface(news) = {ll_12_C_Window, ll_Coil_C_prim_m, ll_Coil_C_second_m};

    // Air 23 Window
    ll_23_A_Window=newll; Curve Loop(newll) = {l_23_A_Window[]};
    s_23_A_Window=news; Plane Surface(news) = {ll_23_A_Window, ll_Coil_A_prim_p, ll_Coil_A_second_p};

    ll_23_B_Window=newll; Curve Loop(newll) = {l_23_B_Window[]};
    s_23_B_Window=news; Plane Surface(news) = {ll_23_B_Window, ll_Coil_B_prim_p, ll_Coil_B_second_p};

    ll_23_C_Window=newll; Curve Loop(newll) = {l_23_C_Window[]};
    s_23_C_Window=news; Plane Surface(news) = {ll_23_C_Window, ll_Coil_C_prim_p, ll_Coil_C_second_p};

    s_Core_A=news; Plane Surface(news) = {ll_CoreA_Env, ll_12_A_Window, ll_23_A_Window};
    s_Core_B=news; Plane Surface(news) = {ll_CoreB_Env, ll_12_B_Window, ll_23_B_Window};
    s_Core_C=news; Plane Surface(news) = {ll_CoreC_Env, ll_12_C_Window, ll_23_C_Window};
    ...
    Physical Surface("AIR_EXT", AIR_EXT) = {s_Air_Ext,  s_12_A_Window, s_23_A_Window, 
                                                        s_12_B_Window, s_23_B_Window, 
                                                        s_12_C_Window, s_23_C_Window};
