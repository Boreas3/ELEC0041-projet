DefineConstant[
    ...
    n_PRIM = {450, Min 100, Max 1000, Step 100, Name "Number of turn - primary side"}
...
If (Config_prim == 1)
  ...
  ElseIf (Config_second == 2)
    n_SECOND = Ceil[Sqrt[3] * n_PRIM/V_ratio];
  EndIf
...
width_Core = 2*width_Window+width_Core_Leg+2*width_external_Core_Leg;


// Thickness along Oz (to be considered for a correct definition of voltage)

height_Core = height_Window+2*width_external_Core_Leg;
