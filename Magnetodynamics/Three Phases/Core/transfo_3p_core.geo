...
// CORE
// Envelop
P_Core_L_0=newp; Point(newp) = {width_Core/2., -height_Core/2, 0, c_Core};
P_Core_L_1=newp; Point(newp) = {width_Core/2., height_Core/2, 0, c_Core};
P_Core_R_0=newp; Point(newp) = {-width_Core/2., -height_Core/2, 0, c_Core};
P_Core_R_1=newp; Point(newp) = {-width_Core/2., height_Core/2, 0, c_Core};
l_Core_Env[]={};
