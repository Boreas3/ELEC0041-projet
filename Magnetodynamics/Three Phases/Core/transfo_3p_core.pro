...
DefineConstant[
  ...
  n_PRIM = {500, Min 100, Max 1000, Step 1, Name "Number of turn - primary side"}
  ...
  { Name Map_a; NameOfPostProcessing Magnetodynamics2D_av;
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        Echo[ "E_in_1", Format Table, File "UI3_core.txt" ];
        Print[ U, OnRegion E_in_1, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion E_in_1, Format FrequencyTable, File > "UI3_core.txt"];

		Echo[ "E_in_2", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion E_in_2, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion E_in_2, Format FrequencyTable, File > "UI3_core.txt"];
        
		Echo[ "E_in_3", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion E_in_3, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion E_in_3, Format FrequencyTable, File > "UI3_core.txt"];
        
		// In text file UI.txt: voltage and current of the secondary coil (from
        // R_out)
        Echo[ "R_out_1", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_out_1, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion R_out_1, Format FrequencyTable, File > "UI3_core.txt"];
		
		Echo[ "R_out_2", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_out_2, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion R_out_2, Format FrequencyTable, File > "UI3_core.txt"];
		
		Echo[ "R_out_3", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_out_3, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ I, OnRegion R_out_3, Format FrequencyTable, File > "UI3_core.txt"];
      EndIf
    }
  }
}
