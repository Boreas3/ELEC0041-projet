  ...
  { Name Map_a; NameOfPostProcessing Magnetodynamics2D_av;
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        Print[ norm_of_I, OnRegion E_in_A, Format Table, File  "UI3_core2.txt"];
        Print[ norm_of_I, OnRegion E_in_B, Format Table, File > "UI3_core2.txt"];
        Print[ norm_of_I, OnRegion E_in_A, Format Table,
		 SendToServer "Output/Norm current - phase A (primary side) [A]" ];
        Print[ norm_of_I, OnRegion E_in_B, Format Table,
        ...
        // R_out)
			  Echo[ "R_load_A", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_load_A, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ norm_of_I, OnRegion R_load_A, Format Table, File > "UI3_core.txt"];
		
		    Echo[ "R_load_B", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_load_B, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ norm_of_I, OnRegion R_load_B, Format Table, File > "UI3_core.txt"];
		
		    Echo[ "R_load_C", Format Table, File > "UI3_core.txt" ];
        Print[ U, OnRegion R_load_C, Format FrequencyTable, File > "UI3_core.txt" ];
        Print[ norm_of_I, OnRegion R_load_C, Format Table, File > "UI3_core.txt"];*/
      EndIf
    }
  }
}
