...
DefineConstant[
  ...
  r_load = {1000, Name "Load secondary side - phase to phase"}
];
    ...
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        // E_in) (real and imaginary parts!)
			  Print[ norm_of_I, OnRegion E_in_A, Format Table, File  "UI3_shell2.txt"];
        Print[ norm_of_I, OnRegion E_in_B, Format Table, File > "UI3_shell2.txt"];
       /*Echo[ "E_in_A", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion E_in_A, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion E_in_A, Format FrequencyTable, File > "UI3_shell.txt"];

		    Echo[ "E_in_B", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion E_in_B, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion E_in_B, Format FrequencyTable, File > "UI3_shell.txt"];
        
		    Echo[ "E_in_C", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion E_in_C, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion E_in_C, Format FrequencyTable, File > "UI3_shell.txt"];
        
		    // In text file UI.txt: voltage and current of the secondary coil (from
        // R_out)
			  Echo[ "R_load_A", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion R_load_A, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion R_load_A, Format FrequencyTable, File > "UI3_shell.txt"];
		
		    Echo[ "R_load_B", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion R_load_B, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion R_load_B, Format FrequencyTable, File > "UI3_shell.txt"];
		
		    Echo[ "R_load_C", Format Table, File > "UI3_shell.txt" ];
        Print[ U, OnRegion R_load_C, Format FrequencyTable, File > "UI3_shell.txt" ];
        Print[ norm_of_I, OnRegion R_load_C, Format FrequencyTable, File > "UI3_shell.txt"];*/
      EndIf
    }
  }
}
