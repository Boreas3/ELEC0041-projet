    ...
    Operation {
      ...
      If (Flag_FrequencyDomain)
        ...
        // E_in) (real and imaginary parts!)
			  Print[ norm_of_I, OnRegion E_in_A, Format Table, File >  "UI3_shell.txt"];
        Print[ norm_of_I, OnRegion E_in_B, Format Table, File > "UI3_shell.txt"];
        ...
        Print[ norm_of_I, OnRegion E_in_C, Format Table, File > "UI3_shell.txt",
